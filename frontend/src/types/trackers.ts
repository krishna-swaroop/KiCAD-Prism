...
export const LINK_STATES = ["linked", "inaccessible", "deleted", "transferred"] as const;
export type LinkState = (typeof LINK_STATES)[number];

export const IDENTITY_STATUSES = ["active", "revoked", "expired"] as const;
export type IdentityStatus = (typeof IDENTITY_STATUSES)[number];

export const CONTAINER_KINDS = ["repo", "group", "project"] as const;
export type ContainerKind = (typeof CONTAINER_KINDS)[number];

export const VISIBILITIES = ["public", "private", "unknown"] as const;
export type TrackerVisibility = (typeof VISIBILITIES)[number];
...
export type TrackerErrorCode = (typeof TRACKER_ERROR_CODES)[number] | string;
