...
- **Release Studio**, a committed-revision manufacturing-document flow that
  publishes a GitHub or GitLab Release. Governed catalog approvals live in
  Library Manager, not here. Operating guides are in
...
review to done and released. Designer and QA responsibilities are separate,
and the Library Manager release path supports a two-person approval model. The
